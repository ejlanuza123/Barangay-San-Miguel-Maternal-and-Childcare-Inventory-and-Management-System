...
export default function AddBnsInventoryModal({ onClose, onSave, mode = "add", initialData = null }) {
  ...
  const title = mode === "edit" ? "Edit BNS Item" : (batchMode ? "Add Multiple BNS Items" : "Add New BNS Item");
      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          {mode === "add" && (
            <button
              ...
              className="text-sm px-3 py-1.5 rounded-md border border-green-300 bg-green-50 text-green-700 hover:bg-green-100"
            >
        ...
        {batchMode ? (
          ...
          <form onSubmit={handleSave} className="space-y-3 text-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="font-semibold text-xs text-gray-600">Unit of Measure (UOM) *</label>
                <select 
                  name="unit" 
                  value={formData.unit || ""} 
                  onChange={handleChange} 
            ...
            <div className="flex justify-end gap-3 pt-4 border-t mt-4">
              ...
              <button 
                type="submit" 
                disabled={loading} 
                className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:bg-gray-400 text-sm font-semibold"
              >
